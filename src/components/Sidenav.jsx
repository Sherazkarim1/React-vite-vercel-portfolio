...
const handleNav = () => {
    ...
    { nav ? (
           <div className='fixed w-full min-h-screen bg-white-90 flex flex-col justify-center items-center z-20'>
  ...
  <a onClick={handleNav}
   ...
   className='w-[75%] flex justify-center items-center rounded-full shadow-lg bg-gray-100 shadow-gray-400 m-2 p-4 cursor-pointer hover:scale-110 ease-in duration-300'>
    ...
    <span className='pl-4'>Home</span>
     ...
     <a onClick={handleNav}
     href='#main' className='w-[75%] flex justify-center items-center rounded-full shadow-lg bg-gray-100 shadow-gray-400 m-2 p-4 cursor-pointer hover:scale-110 ease-in duration-300'>
    <AiOutlineProject size={20} />
    <span className='pl-4'>Porjects</span>
